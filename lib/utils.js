...
exports.loadJsonAsync = async (filePath) => {
  let _0x5cef1e = null
  try {
    _0x5cef1e = await promises.readFile(filePath, 'utf8')
  } catch (_0x36de33) {}
...
exports.getJsonWithUnpack = async (_0x31dd65) => {
  let _0x43573d = null
  try {
    _0x43573d = await inflateRawPromisified(_0x31dd65)
...
exports.removeByPath = (_0x269044) => {
  try {
    if (fs.lstatSync(_0x269044).isDirectory()) {
      for (let _0x568e71 of fs.readdirSync(_0x269044)) {
        fs.unlinkSync(_0x568e71)
      }
      fs.rmdirSync(_0x269044)
    } else {
      fs.unlinkSync(_0x269044)
    }
  } catch (_0x44370e) {
    return null
  }
