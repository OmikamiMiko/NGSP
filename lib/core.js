...
class _0x2ce4ef {
  constructor(modManager) {
    ...
    function OnClientVariousStartSkills(_0x2c6bf3, _0x1e00ce, _0x20e4cc, _0x528520) {
      ...
      if (sendDelayQ > 0) {
        return (
          (_0x5d99c1 = modManager.mod.setTimeout(() => {
            if (
              false !== _0x2c33bf(_0x2c6bf3, _0xb0919c, skillInfo, _0x528520)
            ) {
              _0x4a929d(_0x528520)
            }
          }, sendDelayQ)),
      ...
      return _0x2c33bf(_0x2c6bf3, _0xb0919c, skillInfo, _0x528520)
    }
    ...
    function _0x14084e(_0x43506c, secondArgument, skill, _0x260007) {
      if (
        ...
        if ('grantCharge' == skill.type) {
          _0xa41fae(secondArgument, skill, _0x27a682)
        } else {
          if (
            thisObject.currentBehavior &&
            !thisObject.currentBehavior.skill.equals(secondArgument) &&
            ...
            return _0x5ed407(secondArgument), false
          } else {
            if (
    ...
    function _0x3193cb(skillInfo, _0x2ce1d0, _0x4e0bf0, _0x2e6353) {
      let isNOTSharedSkill = true
      switch (thisObject.currentBehavior.skill.type) {
        case 1:
          ...
          if (
            ...
            isNOTSharedSkill = false
          } else {
            if (
              skillInfo.noInterrupt &&
              (-1 !== skillInfo.noInterrupt.indexOf(_0x2ce1d0) ||
                -1 !==
                  skillInfo.noInterrupt.indexOf(_0x2ce1d0 + '-' + _0x4e0bf0))
            ) {
              isNOTSharedSkill = false
              if (skillInfo.abnormalInterruption) {
                for (let abnormInteruption in skillInfo.abnormalInterruption) {
                  if (modManager.abn.exists(abnormInteruption)) {
                    const _0x50db68 = skillInfo.abnormalInterruption[abnormInteruption]
                    if (Array.isArray(_0x50db68)) {
                      if (-1 !== _0x50db68.indexOf(_0x2ce1d0)) {
                        isNOTSharedSkill = true
                      }
                    } else {
                      ;(_0x2ce1d0 == _0x50db68 ||
                        'all' === _0x50db68 ||
          ...
          if (isNOTSharedSkill && 'storeCharge' == skillInfo.type) {
        ...
        case 2:
          ...
          if (
            ...
            skillInfo.useSkillWhileAirReaction
          ) {
            isNOTSharedSkill = true
          } else {
            modManager.state.baseData.knockdowns[modManager.me.job][
              ...
              'stand' == skillInfo.realType &&
              (isNOTSharedSkill = true)
          }
          break
      }
      return isNOTSharedSkill
    }
